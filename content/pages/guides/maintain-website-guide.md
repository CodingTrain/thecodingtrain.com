...
```json
{
  ...
  "parts": [ <-- add this section
    ...
    {
      "title": "Part 2 - Law of Sines (Update)",
      "videoId": "lobJ9gzbLo8",
      "timestamps": [
        { "time": "00:00", "title": "Title 1" },
        { "time": "00:28", "title": "Title 2" }
...
```json
{
  ...
  "parts": [
    {
      "title": "Part 1 - Only for Multi-Part Challenges",
    ...
    {
      "title": "Part 2 - Part-Specific Title"
